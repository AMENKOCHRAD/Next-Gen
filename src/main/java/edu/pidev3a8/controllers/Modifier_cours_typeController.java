...
public class Modifier_cours_typeController {
    ...
    private Cours_type selectedCoursType;
    private Cours_typeCRUDController coursTypeCRUDController;

    public void setCoursType(Cours_type coursType) {
        this.selectedCoursType = coursType;
        this.typeCoursField.setText(coursType.getType_cours());
        this.descriptionField.setText(coursType.getDescription());
    }
    ...
    void handleUpdate(ActionEvent event) {
        ...
        selectedCoursType.setType_cours(typeCours);
        selectedCoursType.setDescription(description);

        Cours_typeService coursTypeService = new Cours_typeService();
        coursTypeService.updateEntity(selectedCoursType.getId(), selectedCoursType);

        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Success");
        alert.setHeaderText("Type de cours modifié avec succès");
        alert.showAndWait();
